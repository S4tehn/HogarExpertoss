...
$reviewsHtml = @"
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-10">
        <div class="bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
            ...
            <p class="text-sm text-gray-700 italic">"¡Excelente producto! Llegó a tiempo y en perfectas condiciones. Los colores son súper vivos, exactamente como se ve en las fotos."</p>
        ...
        <div class="bg-gray-50 p-6 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition">
            ...
            <p class="text-sm text-gray-700 italic">"Fue para un regalo y a mi novia le encantó. La calidad se siente muy premium, nada que ver con imitaciones baratas."</p>
...
for ($i = 1; $i -le 19; $i++) {
    ...
    $p1 = $parrafos_historia | Get-Random
    $p2 = $parrafos_calidad | Get-Random
    $p3 = $parrafos_regalo | Get-Random
    $p4 = if ((Get-Random -Minimum 0 -Maximum 2) -eq 1) { $parrafos_historia | Get-Random } else { $parrafos_calidad | Get-Random }
...
<head>
    ...
    <meta name="description" content="Descubre todo sobre $productName. Análisis detallado, fotos reales y por qué es el regalo perfecto para cualquier fan de Disney.">
        ...
        <article class="bg-white p-6 md:p-10 rounded-2xl shadow-sm border border-gray-100">
            ...
            <div class="prose prose-lg text-gray-600 max-w-none">
                ...
                <div class="text-center my-10 bg-gray-50 p-6 rounded-xl border border-gray-200">
                    ...
                    <a href="$mlLink" target="_blank" rel="nofollow noopener" class="inline-block bg-blue-600 text-white font-bold py-4 px-8 rounded-full shadow-lg hover:bg-blue-700 hover:shadow-xl transition transform hover:-translate-y-1">
...
"@
    ...
    Set-Content $filepath -Value $htmlTemplate -Encoding UTF8
    Write-Host "Generado $filepath"
}
